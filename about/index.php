...
<div id="about" class="block bgcolor blue3"> 
  <div class="container"> 
    ...
    <h2 class="color blue4 title border-top border-bottom"> Наша задача — эффективное построение 
      <br />
...
<div id="clients" class="bgcolor block blue5"> 
  <div class="container"> 
   ...
   <?$APPLICATION->IncludeComponent("bitrix:news.list", "clients_about", array(
    ...
    <h3 class="title"> И многие другие </h3>
   
    <p class="center"> <a href="#" class="big-button blue3" > НЕ ВЕРИТЕ? СМОТРИТЕ! </a> </p>
   </div>
 </div>
